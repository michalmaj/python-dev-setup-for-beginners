...
These values do not need to match your Linux account name.
...
You do not need `sudo` for Git configuration.
...
This command saves your Git name for your Linux user account.
...
The terminal may say that `git` is not found.
...
Git may show other settings that were created by the system or other tools.
