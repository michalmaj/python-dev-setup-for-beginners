...
- understand when to use the external terminal and the VS Code terminal.
...
It can run commands just like a separate Linux terminal window.
...
On Linux, this terminal will often use Bash or another shell configured for your user account.
...
- a separate Linux terminal window,
...
For installing system tools with `sudo`, a separate terminal window can be easier to read.
...
### The shell looks different inside VS Code
